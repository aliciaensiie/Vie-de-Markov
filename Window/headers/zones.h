...
#define hauteur_case_matrice 38
#define longeur_case_matrice 30
#define debut_matrice_longueur 800
#define debut_matrice_hauteur 100
#define largeur_premierecase 50
#define hauteur_premierecase 19
...
/**
 * \brief: mets à jour la vue de la map aussi bien plateau que matrice
*/
void updateMap(struct VueJeu* vj);

/**
 * \brief: gère les actions sur les zones et la matrice
*/
...
/**
 * \brief : retourne les coeff de la matrice
 */
